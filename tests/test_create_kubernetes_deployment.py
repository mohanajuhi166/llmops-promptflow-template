...
def test_create_kubernetes_deployment():
    ...
    mock_ml_client = Mock()
    with patch("llmops.common.deployment.kubernetes_deployment.MLClient", mock_ml_client), \
            patch("llmops.common.deployment.kubernetes_deployment.AIClient", mock_ml_client):
        # Mock the MLClient
